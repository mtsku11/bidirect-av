...
- [ ] Screen a lower-hue or alternate uploaded-movie second leg for low-saturation footage. `low-sat-pan-speech.mp4 + Movie` still locks on hue even after the weaker upload-specific spread branch.
