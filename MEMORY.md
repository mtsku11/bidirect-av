...
- Current next step: address the remaining low-saturation uploaded-movie hue lockup, likely by reducing the hue leg or trying an alternate visual-to-audio second leg just for uploaded movie cases. Only revisit `Cars` after adding a new feedback-capable route or different control surface.
